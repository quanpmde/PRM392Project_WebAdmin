            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-8" style="border-bottom: 1px solid">
                        ...
                        <c:if test="${not empty loginWarning}">
                            <p style="color:red">${loginWarning}</p>
                        </c:if>
                        ...
                        <!-- Password input -->
                        <div class="form-outline mb-4" data-mdb-input-init>
                            <input type="password" id="form1Example2" minlength="8" class="form-control" placeholder="Mật khẩu" name="password" required/>
                        </div>
